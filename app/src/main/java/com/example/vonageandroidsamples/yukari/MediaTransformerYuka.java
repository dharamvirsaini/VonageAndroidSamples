package com.example.vonageandroidsamples.yukari;
...
import com.example.vonageandroidsamples.MainActivity;
import com.example.vonageandroidsamples.R;
import com.example.vonageandroidsamples.config.ServerConfig;
import com.example.vonageandroidsamples.network.APIService;
import com.example.vonageandroidsamples.network.GetSessionResponse;
...
public class MediaTransformerYuka extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private Session.SessionListener sessionListener = new Session.SessionListener() {
        ...
        public void onConnected(Session session) {
            ...
            publisher = new Publisher.Builder(MediaTransformerYuka.this).build();
        ...
        public void onStreamReceived(Session session, Stream stream) {
            ...
            if (subscriber == null) {
                subscriber = new Subscriber.Builder(MediaTransformerYuka.this, stream).build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_media_transformer);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Basic-Video-Chat-Java");
    ...
    void setupVideoTransformersImages() {
        ...
        watermark = BitmapFactory.decodeResource(context.getResources(), R.drawable.beach);
        ...
        Bitmap bitmap2 = BitmapFactory.decodeResource(resources, R.drawable.meeting); // Assuming "beach" is the name of the drawable resource

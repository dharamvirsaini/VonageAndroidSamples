...
public class BasicVideoCapturer_Java extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {

    private static final String TAG = BasicVideoCapturer_Java.class.getSimpleName();
    ...
    private Session.SessionListener sessionListener = new Session.SessionListener() {
        ...
        public void onConnected(Session session) {
            ...
            MirrorVideoCapturer mirrorVideoCapturer = new MirrorVideoCapturer(
                    BasicVideoCapturer_Java.this,
                    Publisher.CameraCaptureResolution.HIGH,
                    Publisher.CameraCaptureFrameRate.FPS_30);

            publisher = new Publisher.Builder(BasicVideoCapturer_Java.this)
        ...
        public void onDisconnected(Session session) {
            ...
            BasicVideoCapturer_Java.this.session = null;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: ---Basic-Video-Capturer-Java launched---");
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Basic-Video-Capturer-Java");

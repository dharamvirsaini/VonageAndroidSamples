package com.example.vonageandroidsamples.github_official;
...
public class BasicVideoChat extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private Session.SessionListener sessionListener = new Session.SessionListener() {
        ...
        public void onConnected(Session session) {
            ...
            publisher = new Publisher.Builder(BasicVideoChat.this).build();
            ...
            Log.d(TAG, "onConnected: num child views " + publisherViewContainer.getChildCount());
        ...
        public void onStreamReceived(Session session, Stream stream) {
            ...
            Log.d(TAG, "onStreamReceived: Stream Type---- " + stream.getStreamVideoType());

            if (subscriber == null) {
                subscriber = new Subscriber.Builder(BasicVideoChat.this, stream).build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button connectBtn = (Button) findViewById(R.id.button3);
        ...
        Button disconnectBtn = (Button) findViewById(R.id.button4);
